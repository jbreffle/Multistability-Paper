...
#SBATCH --output=jobLogs/log_binaryRandDist-%A-%a.out
#SBATCH --error=jobLogs/err_binaryRandDist-%A-%a.out
...
matlab -nodisplay -nodesktop -nosplash -nojvm -singleCompThread -r "sim_rand_net_binary; exit"
